                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ms-2">
                            ...
                            <p className="lead">
                                ...
                                we will be able to provider the top content for you!
                            </p>
                ...
                <div className="row g-0">
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                Try to check in daily as ours collection is always changing!
                                for our Book Serivce students! We are diligent about our book selection
